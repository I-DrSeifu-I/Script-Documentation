...
$logging = "D:\Scripts\Scripts\RenameVM\logs\($OldVMName)-RenamingLogs.txt"
...
"Deleting the old Azure VM and keeping the other resources intact..." | Out-File -FilePath $logging -Append
...
"Creating the new Azure VM configuration..." | Out-File -FilePath $logging -Append
...
"Attaching the Windows OS Managed Disk of the old VM to the new Azure VM..."| Out-File -FilePath $logging -Append
...
"Attaching the Windows OS UnManaged Disk of the old VM to the new Azure VM..." | Out-File -FilePath $logging -Append
...
"Attaching the Linux OS UnManaged Disk of the old VM to the new Azure VM..." | Out-File -FilePath $logging -Append
...
"Attaching all NICs of the old VM to the new Azure VM..." | Out-File -FilePath $logging -Append
...
"Attaching all Data Disks (if any) of the old VM to the new Azure VM..." | Out-File -FilePath $logging -Append
...
"Creating the new Azure VM..." | Out-File -FilePath $logging -Append
